...
# some vars from the  setup file getting locally reassigned 
...
# set up env variables for various things - you'll need this later to run keystone and neutron-manage commands 
...
/^log_dir =.*$/s/^.*$/log_dir = \/var\/log\/keystone/
